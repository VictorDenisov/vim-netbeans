...
printAddAnno = "0:addAnno!1 2 3 10 5"
               @=?
               (N.printMessage $ N.CommandMessage (N.BufId 0) 1 $ N.AddAnno 2 3 10 5)
...
printDefineAnnoType = "0:defineAnnoType!1 2 \"typeName\" \"toolTip\" \"glyphFile\" Red Green"
                     @=?
                     (N.printMessage $ N.CommandMessage (N.BufId 0) 1 $ N.DefineAnnoType 2 "typeName" "toolTip" "glyphFile" N.Red N.Green)
